...
import { AddRelease, Releases } from "./ManageReleases";
import { Top, AddMusic } from "./ManageTop";
import { Review, AddReviews } from "./ManageReviews";
import { Articles, AddArticle } from "./ManageArticles";
              ...
              <Grid item xs={12}>
                <Paper className={classes.paper}>
                  ...
                  <Route path="/admin/managenews">
                    <News newsID={newsID} setNewsID={setNewsID} />
                  </Route>
                  ...
                  <Route path="/admin/addnews">
                    <AddNews newsID={newsID} setNewsID={setNewsID} />
                  </Route>
                  ...
                  <Route path={`/admin/editNews/:news_id`}>
                    <EditNews newsID={newsID} setNewsID={setNewsID} />
                  </Route>
                </Paper>
              </Grid>
            </Grid>
